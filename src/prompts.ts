export function buildQuizQuestionPrompt(
	...
	const lines = [
		...
		'- Never ask about default values, parameter names, or type annotations — always ask about behavior, purpose, or consequence.',
		'',
		'BAD examples (do not generate these):',
		'- What is the default value of X? (asks about syntax, not behavior)',
		'- What is the parameter name for X? (asks about naming, not comprehension)',
