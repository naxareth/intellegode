...
async function evaluateAnswer(code: string, question: string, answer: string): Promise<string> {
    ...
    '4) Keep feedback concise with no long explanations.',
    '5) For "[PASS]", provide exactly one sentence explaining the key concept you understood correctly.',
    '6) For "[PARTIAL]", provide exactly two sentences: one sentence on what you got right, plus one sentence hint on what you missed.',
    '7) For "[MISS]", provide exactly one sentence nudge in the right direction.',
    '8) Never reveal the full answer or implementation details.',
    '9) Do not mention specific variable names, function names, or code identifiers unless already present in the learner answer.',
    '10) Maximum 2 sentences total.',
    'Example formats:',
    '"[PASS] You correctly identified that..."',
    '"[PARTIAL] You recognized that... You may want to think more about..."',
    '"[MISS] You may be pointing in the wrong direction, so think about..."',
		'',
		'Code:',
		code,
		'',
