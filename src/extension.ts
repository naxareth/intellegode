...
async function evaluateAnswer(code: string, question: string, answer: string): Promise<string> {
    ...
    '1) Output must be on one line: [LABEL] followed immediately by feedback text.',
    '2) The label must ALWAYS be followed by a feedback sentence on the same line.',
    '3) Returning only [PASS], [PARTIAL], or [MISS] with no explanation is not allowed.',
    '4) Keep feedback to 1-2 sentences maximum.',
    '5) For "[PARTIAL]", give exactly one sentence hint about what was missed, nothing more.',
    '6) For "[MISS]", give exactly one sentence nudge in the right direction.',
    '7) Never reveal the full answer or implementation details.',
    '8) No long explanations.',
    'Example formats:',
    '"[PASS] You correctly identified that..."',
    '"[PARTIAL] You got the general idea but missed..."',
    '"[MISS] The answer is pointing in the wrong direction - think about..."',
		'',
		'Code:',
		code,
		'',
